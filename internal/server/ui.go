...
<div class="hdr">
<h1 id="dash-title"><span>&#9670;</span> VIADUCT</h1>
...
<script>
var A='/api';
var RESOURCE='tunnels';
var TITLE_FIELD='name';

var fields=[{"name": "id", "label": "Id", "type": "text"}, {"name": "name", "label": "Name", "type": "text"}, {"name": "local_port", "label": "Local Port", "type": "integer"}, {"name": "remote_host", "label": "Remote Host", "type": "text"}, {"name": "remote_port", "label": "Remote Port", "type": "integer"}, {"name": "protocol", "label": "Protocol", "type": "text"}, {"name": "status", "label": "Status", "type": "text"}, {"name": "bytes_transferred", "label": "Bytes Transferred", "type": "integer"}, {"name": "created_at", "label": "Created At", "type": "text"}];
