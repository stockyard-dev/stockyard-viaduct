...
func(s *Server)create(w http.ResponseWriter,r *http.Request){var e store.Tunnel;json.NewDecoder(r.Body).Decode(&e);if e.Name==""{we(w,400,"name required");return};s.db.Create(&e);wj(w,201,s.db.Get(e.ID))}
